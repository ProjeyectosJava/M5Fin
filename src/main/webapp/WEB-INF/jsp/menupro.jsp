	...
	<header>
		...
		<a class="navbar-brand" href="${baseURL}"> <span class="fas fa-home"></span></a>
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link"	href="${baseURL}/profesional/crearcapacitacion">Crear capacitacion </a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link" href="${baseURL}/profesional/responderchecklist">Responder Checklist</a>
					</li>
				</ul>
			</div>
		</nav>

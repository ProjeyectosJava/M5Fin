		...
		<div class="col-md-10">
			...
			<form:form method="post" action="../../guardarchecklist" modelAttribute="chequeo">
				<div class="form-group row">
					...
					<div class="col-md-7">
						<form:input class="form-control" id="idvisitachequeo"  path="visita.idvisita" readonly="true"/>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-md-7">
						<form:input class="form-control" id="estadochequeo"  path="estadochequeo" readonly="true"/>
					</div>
				</div>
				
				
				<div class="form-group row">
					<label for="detallechequeo" class="col-md-2 col-form-label mr-1">Ingrese Detalle</label>
					<div class="col-md-7">	
